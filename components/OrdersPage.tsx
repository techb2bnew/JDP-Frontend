            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-2xl font-semibold text-yellow-600">
                  {isLoadingStats ? (
                      <div className="animate-spin rounded-full h-6 w-6 border-b-2 text-yellow-600"></div>
                    ) : (
                      pendingOrders
                  )}
                  </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-2xl font-semibold text-blue-600">
                  {isLoadingStats ? (
                      <div className="animate-spin rounded-full h-6 w-6 border-b-2 text-blue-600"></div>
                    ) : (
                      processingOrders
                  )}
                  </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-2xl font-semibold text-green-600">
                  {isLoadingStats ? (
                      <div className="animate-spin rounded-full h-6 w-6 border-b-2 text-green-600"></div>
                    ) : (
                      completedOrders
                  )}
                  </div>
