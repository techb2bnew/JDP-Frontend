  ...
  return (
    <div className="relative flex h-full min-h-0 min-w-0 flex-col overflow-hidden border border-sky-100 bg-gradient-to-b from-white via-sky-50/40 to-blue-50/40 shadow-[0_8px_22px_rgba(59,130,246,0.08)]">
      <ScrollArea className="min-h-0 flex-1">
        <div className={`p-3 ${shouldShowFooter ? "pb-32" : ""}`}>
          {isLoading ? (
                  ...
                  >
                    ...
                    {hasJobs && (
                      <CollapsibleContent className="px-2 pb-3 pt-2">
                        <div className="relative ml-2 min-w-0 border-l-2 border-sky-100 pl-3">
                          {entityJobs.map((job) => {
                                              ...
                                              >
                                                ...
                                                >
                                                  <div className="flex min-w-0 items-center gap-1.5">
                                                    <div className="flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-amber-50 ring-[1.5px] ring-amber-300">
                                                    ...
                                                    <div className="flex min-w-0 flex-1 items-center justify-between gap-1.5 overflow-hidden">
                                                      ...
                                                      <div className="shrink whitespace-nowrap rounded-full border border-sky-100 bg-sky-50 px-2 py-0.5 text-[9px] font-semibold text-sky-600">
                                                        Change Order
                                                      </div>
                                                    </div>
                                                  </div>
